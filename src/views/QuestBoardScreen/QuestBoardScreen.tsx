  ...
  return (
    <SafeAreaView style={standardStyles.container}>
      <Div flex={1} bg="white" px="lg" py="sm">
        <Div shadow={"sm"} p="lg" bg="white" row justifyContent="space-between" rounded={"sm"} mx="sm" mt="sm">
        ...
        <ScrollDiv showsVerticalScrollIndicator={false} contentContainerStyle={{paddingBottom: 10}}>
          {[0, 1, 2, 3, 4, 5, 6].map((e) => {
            return (
              <Quest navigation={navigation} colors={e % 4 === 2 ? "blue" : e % 4 === 3 ? "green" : "white"} key={e} number={e} />
            );
          })}
        </ScrollDiv>
      </Div>
